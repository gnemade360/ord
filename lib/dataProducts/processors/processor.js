...
class DataProductProcessorChain {
    ...
    buildChain() {
        ...
        // Set up the chain with all processors
        defaultsProcessor
    ...
    async process(context) {
        ...
        try {
            // Start with empty array, DefaultsProcessor will create the initial data products
...
// Export a factory function for easier testing and usage
